...
def main():
    ...
    fire_dragon = TournamentCard("Fire Dragon", cost=5, rarity="Legendary", attack=7, health=5)
    ice_wizard = TournamentCard("Ice Wizard", cost=4, rarity="Epic", attack=6, health=4)
    ...
    for idx, entry in enumerate(leaderboard, 1):
        ...
        print(f"{idx}. {card.name} - Rating: {entry['rating']} ({card.wins}-{card.losses})")
